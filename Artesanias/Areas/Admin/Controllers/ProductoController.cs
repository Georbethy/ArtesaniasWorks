...
namespace Artesanias.Areas.Admin.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductoId,Nombre,Categoria,Descripcion,Precio,Existencias")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductoId,Nombre,Categoria,Descripcion,Precio,Existencias")] Producto producto)
        {
            if (ModelState.IsValid)
            {
